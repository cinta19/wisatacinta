                        ...
                        <div class="row tm-banner-row tm-banner-row-header">
                            <div class="col-xs-12">
                                <div class="tm-banner-header">
                                    <h1 class="text-uppercase tm-banner-title">Tour and Travel Cinta</h1>
                                    <img src="img/dots-3.png" alt="Dots">
                                    <p class="tm-banner-subtitle">Selamat datang di Agen Tour dan Travel kami!
                                    Liburan membuat kamu melupakan permasalahan kehidupan dan berfokus pada keindahan kehidupan, karena itu berliburlah agar kamu berbahagia.
                                </p>
